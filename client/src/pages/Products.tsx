import { useBatchCreateProducts, useCreateProduct, useProducts, useCategories } from "@/hooks/use-products";
...
import { insertProductSchema, type Product, type Category } from "@/lib/schema";
import {
  Form,
  FormControl,
  FormField,
