...
import { ArrowUpRight, CheckCircle2, Clock, FileText, Loader2, Plus } from "lucide-react";
...
export default function Dashboard() {
  ...
  const stats = [
    ...
    {
      label: "Verified",
      value: orders?.filter((o) => o.status === "verified").length || 0,
      icon: CheckCircle2,
      color: "text-mint",
      bg: "bg-mint/10",
    },
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between px-1">
          ...
          <Link
            href="/orders"
            className="text-sm font-medium text-primary hover:text-amber-400 flex items-center gap-1"
          >
